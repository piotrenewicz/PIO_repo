...
select = "(SELECT ZAKU_NUMER_DOK AS NR, ZAKU_DATA AS DATA,KONT_NAZWA AS NAZWA,KONT_NAZWA2 AS NAZWA2,ZAKU_BEZ_PODATKU AS BEZ_PODATKU,ZAKU_ODLICZ AS ODLICZ,ZAKU_ZAPLACONO AS ZAPLACONO,ZAKU_TERMIN_ZAPL AS TERMIN_ZAPLATYFROM VIEW_OKNO_ZAKU)"

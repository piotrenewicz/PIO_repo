...
def lobby():
    ...
    myLabel0.grid(row=y+1, column=0)

    id = Entry(main_window, width=10, borderwidth=3)
    id.grid(row=y+2, column=1)
    ...
    button_0.grid(row=y+3, column=0)
    button_1.grid(row=y+4, column=0)
    button_2.grid(row=y+5, column=0)
    button_3.grid(row=y+6, column=1)
